    ...
    */
    ...
    function locale (locale, callBack) {
		...
		if (locale.length === 5) {
			...
			let data = getCustomLocale(locale);
			if(data != null) {
	...
	function getCustomLocale(locale) {
		let customLocale;
		if (locale.length === 5) {
			if(locale === 'es_MX') {
				customLocale = {
				    ...
				    "phrases" : {
				        ...
				        "Attach files by dragging and dropping or Click to Select": "Adjunta archivos al arrastrar y soltar o click para seleccionar",
				        ...
				        "Reset Column Size": "Reponer tamaño de columnas",
				        "Reset": "Reponer",
				        "Restore Default State": "Reponer estado",
				        "Return data is not in JSON format. See console for more information.": "Datos retornados no están en formato JSON. Ver consola para más información.",
				        ...
				        "Select Minute" : "Seleccione minuto"
				    }
				};
			}
		}
